    ...
    <div style={{ fontFamily: "'Barlow', sans-serif", minHeight: "100vh", background: "#E8E0D0", color: "#2C2C1E" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card { background: #F0E8D8; border: 1px solid #C8B89A; border-radius: 4px; position: relative; }
        ...
        .tab-btn { border: 1px solid #C8B89A; cursor: pointer; font-family: 'Barlow Condensed', sans-serif; font-size: 11px; font-weight: 600; letter-spacing: .1em; text-transform: uppercase; transition: all .15s; border-radius: 3px; white-space: nowrap; background: transparent; color: #8B7355; padding: 6px 14px; }
        ...
        .upload-zone { border: 2px dashed #C8B89A; border-radius: 6px; background: #EDE5D5; transition: all .2s; cursor: pointer; }
        ...
        @media(max-width:480px) { .stat-big { font-size: 42px !important; } }
      `}</style>
